...
pub fn HPy_FromVoidP(arg_p: ?*anyopaque) callconv(.C) HPy {
    var p = arg_p;
    return HPy{
        ._i = @as(isize, @intCast(@intFromPtr(p))),
    };
}
pub fn HPy_AsVoidP(arg_h: HPy) callconv(.C) ?*anyopaque {
    var h = arg_h;
    return @as(?*anyopaque, @ptrFromInt(h._i));
}
...
pub fn HPyCapsule_GetPointer(arg_ctx: [*c]HPyContext, arg_capsule: HPy, arg_name: [*c]const u8) callconv(.C) ?*anyopaque {
    ...
    var capsule = arg_capsule;
    var name = arg_name;
    return ctx.*.ctx_Capsule_Get.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Pointer)), name);
}
pub fn HPyCapsule_GetName(arg_ctx: [*c]HPyContext, arg_capsule: HPy) callconv(.C) [*c]const u8 {
    var ctx = arg_ctx;
    var capsule = arg_capsule;
    return @as([*c]const u8, @ptrCast(@alignCast(ctx.*.ctx_Capsule_Get.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Name)), null))));
}
pub fn HPyCapsule_GetContext(arg_ctx: [*c]HPyContext, arg_capsule: HPy) callconv(.C) ?*anyopaque {
    var ctx = arg_ctx;
    var capsule = arg_capsule;
    return ctx.*.ctx_Capsule_Get.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Context)), null);
}
pub fn HPyCapsule_SetPointer(arg_ctx: [*c]HPyContext, arg_capsule: HPy, arg_pointer: ?*anyopaque) callconv(.C) c_int {
    var ctx = arg_ctx;
    var capsule = arg_capsule;
    var pointer = arg_pointer;
    return ctx.*.ctx_Capsule_Set.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Pointer)), pointer);
}
pub fn HPyCapsule_SetName(arg_ctx: [*c]HPyContext, arg_capsule: HPy, arg_name: [*c]const u8) callconv(.C) c_int {
    var ctx = arg_ctx;
    var capsule = arg_capsule;
    var name = arg_name;
    return ctx.*.ctx_Capsule_Set.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Name)), @as(?*anyopaque, @ptrCast(@volatileCast(@constCast(name)))));
}
pub fn HPyCapsule_SetContext(arg_ctx: [*c]HPyContext, arg_capsule: HPy, arg_context: ?*anyopaque) callconv(.C) c_int {
    ...
    return ctx.*.ctx_Capsule_Set.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Context)), context);
}
pub fn HPyCapsule_SetDestructor(arg_ctx: [*c]HPyContext, arg_capsule: HPy, arg_destructor: [*c]HPyCapsule_Destructor) callconv(.C) c_int {
    ...
    var capsule = arg_capsule;
    var destructor = arg_destructor;
    return ctx.*.ctx_Capsule_Set.?(ctx, capsule, @as(c_uint, @bitCast(HPyCapsule_key_Destructor)), @as(?*anyopaque, @ptrCast(destructor)));
}
...
} // /tmp/tmpvpne6mnf/include/hpy/inline_helpers.h:66:1: warning: TODO unable to translate variadic function, demoted to extern
...
pub fn HPyLong_FromLong(arg_ctx: [*c]HPyContext, arg_l: c_long) callconv(.C) HPy {
    var ctx = arg_ctx;
    var l = arg_l;
    if (@sizeOf(c_long) <= @sizeOf(i32)) return HPyLong_FromInt32_t(ctx, @as(i32, @bitCast(@as(c_int, @truncate(l)))));
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_long) <= @sizeOf(i64)) {} else {
                __assert_fail("sizeof(long) <= sizeof(int64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 145))), "HPy HPyLong_FromLong(HPyContext *, long)");
            };
        };
    };
    return HPyLong_FromInt64_t(ctx, @as(i64, @bitCast(l)));
}
pub fn HPyLong_FromUnsignedLong(arg_ctx: [*c]HPyContext, arg_l: c_ulong) callconv(.C) HPy {
    var ctx = arg_ctx;
    var l = arg_l;
    if (@sizeOf(c_ulong) <= @sizeOf(u32)) return HPyLong_FromUInt32_t(ctx, @as(u32, @bitCast(@as(c_uint, @truncate(l)))));
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_ulong) <= @sizeOf(u64)) {} else {
                __assert_fail("sizeof(unsigned long) <= sizeof(uint64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 165))), "HPy HPyLong_FromUnsignedLong(HPyContext *, unsigned long)");
            };
        };
    };
    return HPyLong_FromUInt64_t(ctx, @as(u64, @bitCast(l)));
}
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_longlong) <= @sizeOf(i64)) {} else {
                __assert_fail("sizeof(long long) <= sizeof(int64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 183))), "HPy HPyLong_FromLongLong(HPyContext *, long long)");
            };
        };
    };
    return HPyLong_FromInt64_t(ctx, @as(i64, @bitCast(@as(c_long, @truncate(l)))));
}
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_ulonglong) <= @sizeOf(u64)) {} else {
                __assert_fail("sizeof(unsigned long long) <= sizeof(uint64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 201))), "HPy HPyLong_FromUnsignedLongLong(HPyContext *, unsigned long long)");
            };
        };
    };
    return HPyLong_FromUInt64_t(ctx, @as(u64, @bitCast(@as(c_ulong, @truncate(l)))));
}
pub fn HPyLong_AsLong(arg_ctx: [*c]HPyContext, arg_h: HPy) callconv(.C) c_long {
    var ctx = arg_ctx;
    var h = arg_h;
    if (@sizeOf(c_long) <= @sizeOf(i32)) return @as(c_long, @bitCast(@as(c_long, HPyLong_AsInt32_t(ctx, h)))) else if (@sizeOf(c_long) <= @sizeOf(i64)) return @as(c_long, @bitCast(HPyLong_AsInt64_t(ctx, h)));
    return 0;
}
pub fn HPyLong_AsUnsignedLong(arg_ctx: [*c]HPyContext, arg_h: HPy) callconv(.C) c_ulong {
    var ctx = arg_ctx;
    var h = arg_h;
    if (@sizeOf(c_ulong) <= @sizeOf(u32)) return @as(c_ulong, @bitCast(@as(c_ulong, HPyLong_AsUInt32_t(ctx, h)))) else if (@sizeOf(c_ulong) <= @sizeOf(u64)) return @as(c_ulong, @bitCast(HPyLong_AsUInt64_t(ctx, h)));
    return 0;
}
pub fn HPyLong_AsUnsignedLongMask(arg_ctx: [*c]HPyContext, arg_h: HPy) callconv(.C) c_ulong {
    var ctx = arg_ctx;
    var h = arg_h;
    if (@sizeOf(c_ulong) <= @sizeOf(u32)) return @as(c_ulong, @bitCast(@as(c_ulong, HPyLong_AsUInt32_tMask(ctx, h)))) else if (@sizeOf(c_ulong) <= @sizeOf(u64)) return @as(c_ulong, @bitCast(HPyLong_AsUInt64_tMask(ctx, h)));
    return 0;
}
pub fn HPyLong_AsLongLong(arg_ctx: [*c]HPyContext, arg_h: HPy) callconv(.C) c_longlong {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_longlong) <= @sizeOf(i64)) {} else {
                __assert_fail("sizeof(long long) <= sizeof(int64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 322))), "long long HPyLong_AsLongLong(HPyContext *, HPy)");
            };
        };
    };
    return @as(c_longlong, @bitCast(@as(c_longlong, HPyLong_AsInt64_t(ctx, h))));
}
pub fn HPyLong_AsUnsignedLongLong(arg_ctx: [*c]HPyContext, arg_h: HPy) callconv(.C) c_ulonglong {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_ulonglong) <= @sizeOf(u64)) {} else {
                __assert_fail("sizeof(unsigned long long) <= sizeof(uint64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 348))), "unsigned long long HPyLong_AsUnsignedLongLong(HPyContext *, HPy)");
            };
        };
    };
    return @as(c_ulonglong, @bitCast(@as(c_ulonglong, HPyLong_AsUInt64_t(ctx, h))));
}
pub fn HPyLong_AsUnsignedLongLongMask(arg_ctx: [*c]HPyContext, arg_h: HPy) callconv(.C) c_ulonglong {
    ...
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (@sizeOf(c_ulonglong) <= @sizeOf(u64)) {} else {
                __assert_fail("sizeof(unsigned long long) <= sizeof(uint64_t)", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 377))), "unsigned long long HPyLong_AsUnsignedLongLongMask(HPyContext *, HPy)");
            };
        };
    };
    return @as(c_ulonglong, @bitCast(@as(c_ulonglong, HPyLong_AsUInt64_tMask(ctx, h))));
}
...
pub fn HPySlice_AdjustIndices(arg___HPy_UNUSED_TAGGEDctx: [*c]HPyContext, arg_length: HPy_ssize_t, arg_start: [*c]HPy_ssize_t, arg_stop: [*c]HPy_ssize_t, arg_step: HPy_ssize_t) callconv(.C) HPy_ssize_t {
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (step != @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {} else {
                __assert_fail("step != 0", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 426))), "HPy_ssize_t HPySlice_AdjustIndices(HPyContext *, HPy_ssize_t, HPy_ssize_t *, HPy_ssize_t *, HPy_ssize_t)");
            };
        };
    };
    _ = blk: {
        ...
        break :blk blk_1: {
            break :blk_1 if (step >= -@as(c_long, 9223372036854775807)) {} else {
                __assert_fail("step >= -HPY_SSIZE_T_MAX", "/tmp/tmpvpne6mnf/include/hpy/inline_helpers.h", @as(c_uint, @bitCast(@as(c_int, 427))), "HPy_ssize_t HPySlice_AdjustIndices(HPyContext *, HPy_ssize_t, HPy_ssize_t *, HPy_ssize_t *, HPy_ssize_t)");
            };
        };
    };
    if (start.* < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {
        start.* += length;
        if (start.* < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {
            start.* = @as(HPy_ssize_t, @bitCast(@as(c_long, if (step < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) -@as(c_int, 1) else @as(c_int, 0))));
        }
    } else if (start.* >= length) {
        start.* = if (step < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) length - @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 1)))) else length;
    }
    if (stop.* < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {
        stop.* += length;
        if (stop.* < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {
            stop.* = @as(HPy_ssize_t, @bitCast(@as(c_long, if (step < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) -@as(c_int, 1) else @as(c_int, 0))));
        }
    } else if (stop.* >= length) {
        stop.* = if (step < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) length - @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 1)))) else length;
    }
    if (step < @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 0))))) {
        if (stop.* < start.*) {
            return @divTrunc((start.* - stop.*) - @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 1)))), -step) + @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 1))));
        }
    } else {
        if (start.* < stop.*) {
            return @divTrunc((stop.* - start.*) - @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 1)))), step) + @as(HPy_ssize_t, @bitCast(@as(c_long, @as(c_int, 1))));
        }
    }
    return 0;
}
pub fn HPy_CallMethodTupleDict_s(arg_ctx: [*c]HPyContext, arg_utf8_name: [*c]const u8, arg_receiver: HPy, arg_args: HPy, arg_kw: HPy) callconv(.C) HPy {
    ...
    if (method._i == @as(isize, @bitCast(@as(c_long, @as(c_int, 0))))) {
        return HPy{
            ._i = @as(isize, @bitCast(@as(c_long, @as(c_int, 0)))),
        };
    }
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/f-cozzocrea/venv/hpy-zig/lib/python3.11/site-packages/ziglang/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/f-cozzocrea/venv/hpy-zig/lib/python3.11/site-packages/ziglang/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/f-cozzocrea/venv/hpy-zig/lib/python3.11/site-packages/ziglang/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/f-cozzocrea/venv/hpy-zig/lib/python3.11/site-packages/ziglang/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/f-cozzocrea/venv/hpy-zig/lib/python3.11/site-packages/ziglang/lib/include/stdarg.h:46:9
pub const _HPy_HIDDEN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /tmp/tmpvpne6mnf/include/hpy.h:71:12
pub const _HPy_UNUSED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /tmp/tmpvpne6mnf/include/hpy.h:72:12
pub const _HPy_UNUSED_ARG = @compileError("unable to translate macro: undefined identifier `__HPy_UNUSED_TAGGED`"); // /tmp/tmpvpne6mnf/include/hpy.h:77:9
pub const _HPy_NO_RETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /tmp/tmpvpne6mnf/include/hpy.h:83:11
pub const _HPY_compiler_has_attribute = @compileError("unable to translate macro: undefined identifier `__has_attribute`"); // /tmp/tmpvpne6mnf/include/hpy.h:94:12
pub const _HPY_LEGACY = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /tmp/tmpvpne6mnf/include/hpy.h:102:13
pub const HPyAPI_FUNC = @compileError("unable to translate C expr: unexpected token 'static'"); // /tmp/tmpvpne6mnf/include/hpy.h:140:9
pub const HPy_EXPORTED_SYMBOL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /tmp/tmpvpne6mnf/include/hpy/hpyexports.h:9:17
pub const HPy_New = @compileError("unable to translate C expr: expected ')' instead got '*'"); // /tmp/tmpvpne6mnf/include/hpy/macros.h:12:9
pub const HPy_RETURN_RICHCOMPARE = @compileError("unable to translate macro: undefined identifier `result`"); // /tmp/tmpvpne6mnf/include/hpy/macros.h:29:9
pub const HPy_BEGIN_LEAVE_PYTHON = @compileError("unable to translate macro: undefined identifier `_token`"); // /tmp/tmpvpne6mnf/include/hpy/macros.h:64:9
pub const HPy_END_LEAVE_PYTHON = @compileError("unable to translate macro: undefined identifier `_token`"); // /tmp/tmpvpne6mnf/include/hpy/macros.h:68:9
pub const HPyFunc_DECLARE = @compileError("unable to translate macro: undefined identifier `_sig`"); // /tmp/tmpvpne6mnf/include/hpy/hpyfunc.h:66:9
pub const HPyFunc_TRAMPOLINE = @compileError("unable to translate macro: undefined identifier `_sig`"); // /tmp/tmpvpne6mnf/include/hpy/hpyfunc.h:78:9
pub const HPy_VISIT = @compileError("unable to translate macro: undefined identifier `vret`"); // /tmp/tmpvpne6mnf/include/hpy/hpyfunc.h:104:9
pub const _HPyFunc_DECLARE_HPyFunc_NOARGS = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:13:9
pub const _HPyFunc_DECLARE_HPyFunc_O = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:14:9
pub const _HPyFunc_DECLARE_HPyFunc_VARARGS = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:15:9
pub const _HPyFunc_DECLARE_HPyFunc_KEYWORDS = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:16:9
pub const _HPyFunc_DECLARE_HPyFunc_UNARYFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:17:9
pub const _HPyFunc_DECLARE_HPyFunc_BINARYFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:18:9
pub const _HPyFunc_DECLARE_HPyFunc_TERNARYFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:19:9
pub const _HPyFunc_DECLARE_HPyFunc_INQUIRY = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:20:9
pub const _HPyFunc_DECLARE_HPyFunc_LENFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:21:9
pub const _HPyFunc_DECLARE_HPyFunc_SSIZEARGFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:22:9
pub const _HPyFunc_DECLARE_HPyFunc_SSIZESSIZEARGFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:23:9
pub const _HPyFunc_DECLARE_HPyFunc_SSIZEOBJARGPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:24:9
pub const _HPyFunc_DECLARE_HPyFunc_SSIZESSIZEOBJARGPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:25:9
pub const _HPyFunc_DECLARE_HPyFunc_OBJOBJARGPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:26:9
pub const _HPyFunc_DECLARE_HPyFunc_FREEFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:27:9
pub const _HPyFunc_DECLARE_HPyFunc_GETATTRFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:28:9
pub const _HPyFunc_DECLARE_HPyFunc_GETATTROFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:29:9
pub const _HPyFunc_DECLARE_HPyFunc_SETATTRFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:30:9
pub const _HPyFunc_DECLARE_HPyFunc_SETATTROFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:31:9
pub const _HPyFunc_DECLARE_HPyFunc_REPRFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:32:9
pub const _HPyFunc_DECLARE_HPyFunc_HASHFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:33:9
pub const _HPyFunc_DECLARE_HPyFunc_RICHCMPFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:34:9
pub const _HPyFunc_DECLARE_HPyFunc_GETITERFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:35:9
pub const _HPyFunc_DECLARE_HPyFunc_ITERNEXTFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:36:9
pub const _HPyFunc_DECLARE_HPyFunc_DESCRGETFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:37:9
pub const _HPyFunc_DECLARE_HPyFunc_DESCRSETFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:38:9
pub const _HPyFunc_DECLARE_HPyFunc_INITPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:39:9
pub const _HPyFunc_DECLARE_HPyFunc_NEWFUNC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:40:9
pub const _HPyFunc_DECLARE_HPyFunc_GETTER = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:41:9
pub const _HPyFunc_DECLARE_HPyFunc_SETTER = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:42:9
pub const _HPyFunc_DECLARE_HPyFunc_OBJOBJPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:43:9
pub const _HPyFunc_DECLARE_HPyFunc_GETBUFFERPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:44:9
pub const _HPyFunc_DECLARE_HPyFunc_RELEASEBUFFERPROC = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:45:9
pub const _HPyFunc_DECLARE_HPyFunc_TRAVERSEPROC = @compileError("unable to translate macro: undefined identifier `object`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:46:9
pub const _HPyFunc_DECLARE_HPyFunc_DESTRUCTOR = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:47:9
pub const _HPyFunc_DECLARE_HPyFunc_DESTROYFUNC = @compileError("unable to translate C expr: unexpected token 'static'"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:48:9
pub const _HPyFunc_DECLARE_HPyFunc_MOD_CREATE = @compileError("unable to translate macro: undefined identifier `ctx`"); // /tmp/tmpvpne6mnf/include/hpy/autogen_hpyfunc_declare.h:49:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_VARARGS = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:45:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_KEYWORDS = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:55:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_INITPROC = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:66:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_NEWFUNC = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:76:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_DESTROYFUNC = @compileError("unable to translate C expr: unexpected token 'static'"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:89:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_RICHCMPFUNC = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:95:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_GETBUFFERPROC = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:112:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_RELEASEBUFFERPROC = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:126:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_TRAVERSEPROC = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:144:9
pub const HPyCapsule_DESTRUCTOR_TRAMPOLINE = @compileError("unable to translate macro: undefined identifier `capsule`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:154:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_MOD_CREATE = @compileError("unable to translate macro: undefined identifier `spec`"); // /tmp/tmpvpne6mnf/include/hpy/universal/hpyfunc_trampolines.h:166:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_NOARGS = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:18:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_O = @compileError("unable to translate macro: undefined identifier `self`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:33:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_UNARYFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:47:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_BINARYFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:62:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_TERNARYFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:78:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_INQUIRY = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:92:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_LENFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:106:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SSIZEARGFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:121:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SSIZESSIZEARGFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:137:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SSIZEOBJARGPROC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:153:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SSIZESSIZEOBJARGPROC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:170:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_OBJOBJARGPROC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:186:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_FREEFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:199:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_GETATTRFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:214:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_GETATTROFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:229:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SETATTRFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:245:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SETATTROFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:261:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_REPRFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:275:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_HASHFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:289:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_GETITERFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:303:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_ITERNEXTFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:317:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_DESCRGETFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:333:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_DESCRSETFUNC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:349:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_GETTER = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:364:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_SETTER = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:380:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_OBJOBJPROC = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:395:9
pub const _HPyFunc_TRAMPOLINE_HPyFunc_DESTRUCTOR = @compileError("unable to translate macro: undefined identifier `arg0`"); // /tmp/tmpvpne6mnf/include/hpy/universal/autogen_hpyfunc_trampolines.h:408:9
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/f-cozzocrea/venv/hpy-zig/lib/python3.11/site-packages/ziglang/lib/include/stddef.h:111:9
pub const HPySlot_SIG = @compileError("unable to translate macro: undefined identifier `_HPySlot_SIG__`"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:219:9
pub const HPyDef_SLOT_IMPL = @compileError("unable to translate macro: undefined identifier `_slot`"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:232:9
pub const HPyDef_SLOT = @compileError("unable to translate macro: undefined identifier `_impl`"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:252:9
pub const _HPyDef_SLOT = @compileError("unable to translate macro: undefined identifier `_trampoline`"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:256:9
pub const HPyDef_METH_IMPL = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:269:9
pub const HPyDef_METH = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:301:9
pub const HPyDef_MEMBER = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:321:9
pub const HPyDef_GET_IMPL = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:332:9
pub const HPyDef_GET = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:359:9
pub const HPyDef_SET_IMPL = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:362:9
pub const HPyDef_SET = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:389:9
pub const HPyDef_GETSET_IMPL = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:392:9
pub const HPyDef_GETSET = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:424:9
pub const HPyCapsule_DESTRUCTOR = @compileError("unable to translate macro: undefined identifier `_impl`"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:427:9
pub const HPyDef_CALL_FUNCTION = @compileError("unable to translate macro: undefined identifier `_impl`"); // /tmp/tmpvpne6mnf/include/hpy/hpydef.h:450:9
pub const HPyAPI_UNUSED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:6:9
pub const _HPyType_HELPER_TYPE = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:209:9
pub const _HPyType_HELPER_FNAME = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:210:9
pub const _HPyType_HELPER_DEFINE_SHAPE = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:211:9
pub const _HPyType_HELPER_AS_STRUCT = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:213:9
pub const HPyType_HELPERS = @compileError("unable to translate C expr: expected ')' instead got '...'"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:263:9
pub const SHAPE = @compileError("unable to translate macro: undefined identifier `_SHAPE`"); // /tmp/tmpvpne6mnf/include/hpy/hpytype.h:276:9
pub const HPY_MOD_EMBEDDABLE = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /tmp/tmpvpne6mnf/include/hpy/hpymodule.h:23:9
pub const HPy_MODINIT = @compileError("unable to translate macro: undefined identifier `get_required_hpy_major_version_`"); // /tmp/tmpvpne6mnf/include/hpy/hpymodule.h:130:9
...
pub const Py_LIMITED_API = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x030900f0, .hexadecimal);
